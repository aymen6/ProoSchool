...
import com.odoo.MenuAppAfter.PageNotFound;
import com.odoo.Paiement.Views.ICpayment;
import com.odoo.R;
...
//TODO here on change menu and add anthor fragment
    public static List<ODrawerItem> getDrawerItems(Context context) {
        String key = "base.settings";
        List<ODrawerItem> items = new ArrayList<>();
        items.add(new ODrawerItem(key).setTitle(OResource.string(context, R.string.proschoolMenu))
                .setGroupTitle());
        ...
        items.add(new ODrawerItem(key).setTitle(OResource.string(context, R.string.etude))
                .setInstance(PageNotFound.class).setIcon(R.drawable.etude));
        items.add(new ODrawerItem(key).setTitle(OResource.string(context, R.string.transport))
                .setInstance(PageNotFound.class).setIcon(R.drawable.bus));
        items.add(new ODrawerItem(key).setTitle(OResource.string(context, R.string.clubs))
                .setInstance(PageNotFound.class).setIcon(R.drawable.club));
        items.add(new ODrawerItem(key).setTitle(OResource.string(context, R.string.Divers))
                .setInstance(PageNotFound.class).setIcon(R.drawable.divers));
    ...
    public static List<ODrawerItem> baseSettingsItems(Context context) {
        ...
        settings.add(new ODrawerItem(key).setTitle(OResource.string(context,R.string.paiement))
                .setGroupTitle());
//TODO
        settings.add(new ODrawerItem(key).setTitle(OResource.string(context, R.string.Payer))
                .setInstance(ICpayment.class).setIcon(R.drawable.ic_pay));
