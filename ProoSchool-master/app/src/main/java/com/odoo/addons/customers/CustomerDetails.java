...
public class CustomerDetails extends OdooCompatActivity
    ...
    private OForm mForm;
    private App app;
    private TextView Parent,nameStu,address;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String birth=extras.getString("birthday");
        String street=extras.getString("street");
        address=(TextView)findViewById(R.id.address);
        nameStu=(TextView)findViewById(R.id.nameStu);
        Parent=(TextView)findViewById(R.id.ParentX);
        Parent.setText(birth);

        int rowId1 = extras.getInt(OColumn.ROW_ID);
        record = resPartner.browse(rowId1);


        nameStu.setText(record.getString("name"));
        record.put("full_address", resPartner.getAddress(record));

        address.setText( record.getString("full_address"));
