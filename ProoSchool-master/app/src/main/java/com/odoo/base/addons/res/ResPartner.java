...
public class ResPartner extends OModel {
    ...
    OColumn birthdate_student = new OColumn("birthdate_student", ODate.class).setSize(100).setRequired();
    OColumn date = new OColumn("date", ODate.class).setSize(100).setRequired();

    OColumn ref = new OColumn("ref", OVarchar.class).setSize(100).setRequired();
     OColumn gender = new OColumn("gender", OSelection.class)
            .addSelection("male", "Male")
            .addSelection("female", "Female");




        OColumn name = new OColumn("Name", OVarchar.class).setSize(100).setRequired();
    OColumn last_name = new OColumn("lat_name", OVarchar.class).setSize(100).setRequired();
